...
discountRouter.get('/:id', checkDiscountIdValidator, discountController.getDiscountById)
discountRouter.post('/', createDiscountValidator, discountController.createDiscount)
discountRouter.put('/:id', checkDiscountIdValidator, updateDiscountValidator, discountController.updateDiscount)
discountRouter.patch('/:id/change-status', checkDiscountIdValidator, discountController.changeStatusDiscount)
